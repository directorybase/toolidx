...
version: v5
supersedes: outputs/2026-06-05-agent-ready-plan-v4.md
date: 2026-06-05
note: v3 was Gemini's audit-only close-out of v2. v4 incorporated Codex's review of v2. v5 fixes the over-broad §0a guard Codex flagged in v4.
---

# toolidx.dev — Agent-Readiness Plan (isitagentready.com) — v5
